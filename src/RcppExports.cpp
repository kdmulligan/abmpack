...
// sub_vec
// Function to sample n elements from a vector without replacement IntegerVector sub_vec(IntegerVector vec_1, IntegerVector vec_2);
RcppExport SEXP _abmpack_sub_vec(SEXP vec_1SEXP, SEXP vec_2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< IntegerVector >::type vec_1(vec_1SEXP);
    Rcpp::traits::input_parameter< IntegerVector >::type vec_2(vec_2SEXP);
    rcpp_result_gen = Rcpp::wrap(sub_vec(vec_1, vec_2));
    return rcpp_result_gen;
END_RCPP
}
// num_in_q_by_risk
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_abmpack_adjust_for_queue", (DL_FUNC) &_abmpack_adjust_for_queue, 2},
    {"_abmpack_sub_vec", (DL_FUNC) &_abmpack_sub_vec, 2},
